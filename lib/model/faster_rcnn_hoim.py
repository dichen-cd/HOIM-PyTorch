...
# from .faster_rcnn_oim import FasterRCNN_OIM, RoIHeadsWithEmbedding
...
class FasterRCNN_HOIM(GeneralizedRCNN):
    """
    Implements OIM model based on Faster R-CNN.
    ...
    Example::
        ...
        >>> # feature maps to use.
        >>> roi_pooler = torchvision.ops.MultiScaleRoIAlign(featmap_names=['feat_res4'],
        >>>                                                 output_size=7,
        >>>                                                 sampling_ratio=2)
        >>>
